 google.maps.event.addDomListener(window, 'load', init);
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(25.007431570554584,121.45272627093505),
            zoom: 15,
        ...
        var mapElement = document.getElementById('mapkit-5843');
        var map = new google.maps.Map(mapElement, mapOptions);
        var locations = [
            {"title":"台灣國立台灣藝術大學","address":"No. 59, Section 1, Daguan Road, Banqiao District, New Taipei City, Taiwan 22058","desc":"","tel":"","int_tel":"","email":"","web":"","web_formatted":"","open":"","time":"","lat":25.0059234,"lng":121.44764110000006,"vicinity":"No. 59, Section 1, Daguan Road, Banqiao District, New Taipei City, Taiwan 22058","open_hours":"","marker":{"url":"https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi_hdpi.png","scaledSize":{"width":25,"height":42,"f":"px","b":"px"},"origin":{"x":0,"y":0},"anchor":{"x":12,"y":42}},"iw":{"address":true,"desc":true,"email":true,"enable":true,"int_tel":true,"open":true,"open_hours":true,"photo":true,"tel":true,"title":true,"web":true}}
        ];
